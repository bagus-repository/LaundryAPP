...
public class WalletFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnPoint = rootView.findViewById(R.id.btnPoint);
        ...
        btnPoint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent toDashPoin = new Intent(getContext(), DashboardPointActivity.class);
                startActivity(toDashPoin);
            }
        });
        Toolbar toolbar = rootView.findViewById(R.id.toolbar);
        ((AppCompatActivity) getActivity()).setSupportActionBar(toolbar);
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Dompet Ku");
        return rootView;
    }

    private void init_point() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ApiConfig.URL_GET_POINT_SUM, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    if (!error) {
                        btnPoint.setText(String.valueOf(jsonObject.getInt("points"))+" poin  ");
