...
//        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Promo &amp; News");
        ...
        btnRefresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ft.detach(PromoFragment.this).attach(PromoFragment.this).commit();
            }
        });
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new PromFragment(), "Promo");
